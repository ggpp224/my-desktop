...
export const EXACT_COMMAND_RULES: readonly ExactCommandRule[] = [
  ...
  { label: '我的任务', tool: 'search_my_tasks', arguments: {} },
  { label: '经办人bug', tool: 'search_assignee_bugs', arguments: {} },
  { label: '经办人任务', tool: 'search_assignee_tasks', arguments: {} },
  { label: '待办bug', tool: 'search_todo_bugs', arguments: {} },
  { label: '处理中bug', tool: 'search_in_progress_bugs', arguments: {} },
  ...
  { label: '获取npm包版本', tool: 'get_npm_package_versions', arguments: {} },
