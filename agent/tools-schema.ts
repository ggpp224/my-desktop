...
export const toolsSchema = [
  ...
  },
  {
    ...
    function: {
      name: 'deploy_jenkins',
      description: '部署/构建某项目。job=预定义 key（nova、cc-web、react18、biz-solution、biz-guide、scm、base、base18）或完整 Job 名',
      parameters: {
        type: 'object',
        required: ['job'],
        properties: { job: { type: 'string', description: '预定义 key 或完整 Jenkins Job 名' } },
      },
    },
  },
  {
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          taskKey: { type: 'string', description: 'cpxy/react18/cc-web/biz-solution/uikit/shared/scm' },
        },
      },
    },
  },
