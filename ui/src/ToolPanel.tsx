...
const TOOL_GROUPS: ToolGroup[] = [
  ...
  },
  {
    ...
    tools: [
      ...
      { name: 'search_todo_bugs', desc: '按当前日期落入的修复版本迭代查询打开状态的待办缺陷（如：待办bug）' },
      { name: 'search_in_progress_bugs', desc: '按当前日期落入的修复版本迭代查询处理中缺陷，并标注是否已评论「已处理」（如：处理中bug）' },      { name: 'search_online_bugs', desc: '查询 Jira 线上 bug（如：线上bug）' },
